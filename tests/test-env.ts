...
export const testEnv = {
  ...
  PUSH_PUBLIC_VAPID_KEY: process.env.PUSH_PUBLIC_VAPID_KEY || "",
  PUSH_PRIVATE_VAPID_KEY: process.env.PUSH_PRIVATE_VAPID_KEY || "",
  PUSH_VAPID_SUBJECT:
...
export function setupTestEnv() {
  ...
  // Retorna função para restaurar o ambiente original
  return () => {
