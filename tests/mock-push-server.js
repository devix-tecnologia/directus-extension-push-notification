...
const server = http.createServer((req, res) => {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, TTL, Urgency, Topic');
...
server.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`[MOCK-PUSH] Health check: http://localhost:${PORT}/__heartbeat__`);
  console.log(`[MOCK-PUSH] Push endpoint: http://localhost:${PORT}/push/{subscriptionId}`);
});
